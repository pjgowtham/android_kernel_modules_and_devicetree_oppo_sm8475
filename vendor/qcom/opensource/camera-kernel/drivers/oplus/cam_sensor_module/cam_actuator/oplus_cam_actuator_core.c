...
#define SEM1217S_OIS_MODE_ADDR 0x0020
#define SEM1217S_OIS_FIXED_MODE 0x0B

#define SEM1217S_OIS_X_TARGET_ADDR 0x0700
#define SEM1217S_OIS_Y_TARGET_ADDR 0x0702
#define SEM1217S_OIS_X_TARGET_CODE 0x6978
#define SEM1217S_OIS_Y_TARGET_CODE 0x6978
...
int actuator_power_down_second_thread(void *arg)
{
	...
	CAM_INFO(CAM_ACTUATOR,"sem1217s actuator_power_down_thread start ");
    /*tele ois powerdown*/
    rc = cam_actuator_ramwrite(a_ctrl,
				SEM1217S_OIS_MODE_ADDR,
				SEM1217S_OIS_FIXED_MODE,
				1,
				CAMERA_SENSOR_I2C_TYPE_WORD,
				CAMERA_SENSOR_I2C_TYPE_BYTE);

	write_val = ((SEM1217S_OIS_Y_TARGET_CODE << 16) | SEM1217S_OIS_X_TARGET_CODE);
	rc = cam_actuator_ramwrite(a_ctrl,
				SEM1217S_OIS_X_TARGET_ADDR,
				write_val,
				1,
				CAMERA_SENSOR_I2C_TYPE_WORD,
